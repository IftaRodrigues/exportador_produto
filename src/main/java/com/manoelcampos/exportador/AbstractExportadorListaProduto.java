...
public abstract class AbstractExportadorListaProduto implements ExportadorListaProduto {
    ...
    public AbstractExportadorListaProduto() {
        ...
        colunas.add(addNewColuna(Produto::getId, "Código"));
        colunas.add(addNewColuna(Produto::getDescricao, "Descrição"));
        colunas.add(addNewColuna(Produto::getMarca, "Marca"));
        colunas.add(addNewColuna(Produto::getEstoque, "Estoque"));
        colunas.add(addNewColuna(Produto::getModelo, "Modelo"));
